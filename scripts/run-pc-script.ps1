...
Start-Process powershell -ArgumentList "-NoExit -WindowStyle minimized -Command & { cd 'C:\Users\Pc\Documents\Wisso\URU\tenth_firts_quarter\Distribuidos\.net\distributed-tic-tac-toe'; dotnet run --project .\PCClient\PCClient.csproj }"
